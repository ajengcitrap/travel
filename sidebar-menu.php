...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
  ...
  // jika menu data  master dipilih, menu data master aktif
...
if ($_GET["module"]=="master_data") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="?module=jurusan"><i class="fa fa-circle-o"></i> Jurusan </a></li>
  ...
  if ($_GET["module"]=="lap_stok") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="?module=booking"><i class="fa fa-circle-o"></i> Booking </a></li>
            <li><a href="?module=pembayaran"><i class="fa fa-circle-o"></i> Pembayaran </a></li>
            <li><a href="?module=pembatalan"><i class="fa fa-circle-o"></i> Pembatalan </a></li>
          </ul>
      </li>
    <?php
  }
  ...
  // jika menu Laporan tidak dipilih, menu Laporan tidak aktif
	...
	if ($_GET["module"]=="lap_stok") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li class="active"><a href="?module=lap_booking"><i class="fa fa-circle-o"></i> Laporan Booking </a></li>
        		<li><a href="?module=lap_pembayaran"><i class="fa fa-circle-o"></i> Laporan Pembayaran </a></li>
            <li><a href="?module=lap_pembatalan"><i class="fa fa-circle-o"></i> Laporan Pembatalan </a></li>
      		</ul>
    	</li>
    <?php
	}
